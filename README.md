...
Check the misc exposure using nucleai exposure tags.

### Description

Check the exposure of secrets using nucleai exposed panels tags and insert vulnerabilities according to the template severity
